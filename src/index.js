...
function loadSources() {
	const url = 'https://newsapi.org/v2/sources?apiKey=3f684b44242d452c935a3f57d011101c';
...
function loadBy(urlPart) {
	hide('#error-block');
	const url = 'https://newsapi.org/v2/' + urlPart + 'apiKey=3f684b44242d452c935a3f57d011101c';
	const request = new Request(url);
	fetch(request)
		.then(function (response) {
			return response.json();
